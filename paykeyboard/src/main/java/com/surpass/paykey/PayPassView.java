...
public class PayPassView extends RelativeLayout {
    ...
    private LinearLayout ll_show_price;//金额布局
    ...
    private void initView() {
        ...
        tv_price=mPassLayout.findViewById(R.id.tv_price);//金额数量
        ll_show_price=mPassLayout.findViewById(R.id.ll_show_price);//金额布局
        ll_show_price.setVisibility(GONE);//默认不显示
     ...
     * 设置金额显示
     */
    public PayPassView setShowPrice(String price){
        tv_price.setText(price+"");
        ll_show_price.setVisibility(VISIBLE);
        return this;
    }
